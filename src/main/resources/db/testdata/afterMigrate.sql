...
INSERT IGNORE INTO algafood.restaurant (restaurant.id, restaurant.name, restaurant.delivery_fee, restaurant.category_id, restaurant.created, restaurant.updated) VALUES (2, 'The Fifties', 8.00, 2, utc_timestamp, utc_timestamp);
